 ...
 * @author Lenovo
 */
public class AdminSignInAuthentication {
    
    public boolean isAdmin(AdminSignInDto adm){
        ...
        String tablepassword="";
            ...
            String query = "select _password from custsignup where _username='"+_username+"'  AND _type='admin'";
