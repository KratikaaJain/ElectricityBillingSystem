    ...
    <body>
        ...
        <div id="login">
            ...
            <div class="box">
                ...
                <br>
                <div class="box1">
                    <h3 style="color:black;">Show Details</h3>
                    <div class="box2">
                        <button type="button" id="btn1" class="btn btn-secondary btn-sm"><a href="viewCustomerDetails.jsp">Show</a></button>
                    </div>
                </div>
                ...
                <div class="box1">
                    ...
                    <div class="box2">
                        <button type="button" id="btn1" class="btn btn-secondary btn-sm"><a href="updateCustomer.jsp">Update</a></button>
                    </div>
                </div>
                ...
                <div class="box1">
                    ...
                    <div class="box2">
                        <button type="button" id="btn1" class="btn btn-secondary btn-sm"><a href="billStatus1.jsp">Pay</a></button>
                    </div>
                </div>
                <div class="box1">
